...
<a class="link-dark me-1" href="https://spcanelon.substack.com" title="Substack" target="_blank" rel="noopener">{{< bi substack >}}</a>
...
# Sign-up for my newsletter {{< bi substack >}}
...
<br><br>
<iframe src="https://spcanelon.substack.com/embed" width="100%" height="170" style="border:2px solid #FAF0E3; background:white;" frameborder="2" scrolling="no" id="substack-embed"></iframe>
...
<!--     substackUrl: "spcanelon.substack.com", -->
